<template>
    <transition name="v-message-fade" @after-leave="handleAfterLeave">
        ...
        >
            <v-icon dense class="v-message__icon" :style="colorStyle">{{
                iconType
            }}</v-icon>
            <slot>
                <p
...
export default class VMessage extends Vue {
    ...
    type = "info"; // 主题
    customClass = ""; // 自定义类名
    onClose: Function | undefined = undefined; // 关闭时的回调函数, 参数为被关闭的 message 实例
